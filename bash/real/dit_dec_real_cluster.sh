...
#SBATCH -o /dss/dssmcmlfs01/pn57pi/pn57pi-dss-0001/slurm_logs/clare_dev/dit_dec_real.out
#SBATCH -e /dss/dssmcmlfs01/pn57pi/pn57pi-dss-0001/slurm_logs/clare_dev/dit_dec_real.err
...
srun --ntasks-per-node=1 \
    ...
    bash -c "export WANDB_API_KEY=${WANDB_API_KEY} && \
             ...
             bash ./bash/real/dit_dec_real.sh ${SEED}"
